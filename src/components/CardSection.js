  ...
  return (
    <div className="my-10 md:px-8 px-4 max-w-7xl mx-auto">
      <div>
        ...
        <h1 className="  uppercase   heading py-5">
          Lorem ipsum dolor sit
        </h1>
        <p className=" text-text-primary text-base max-w-xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-8 py-8 max-w-4xl mx-auto">
          {bikeHighlights?.map((data) => (
            ...
            >
              ...
              <div className="p-5">
                <p className=" subheading-sm mb-2">
                  {data.title}
                </p>
                <p className="text-base text-text-primary pb-4">
                  {data.description}
                </p>
                <Link
                  href="/"
                  className=" text-primary  cursor-pointer   font-semibold underline transition-all duration-200"
                >
                  Learn more
                </Link>
              </div>
